                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href="/contact" className="px-10 py-5 bg-[#273a96] text-white rounded-full font-bold text-lg hover:bg-[#1e2a78] transition-all shadow-xl hover:-translate-y-1 group flex items-center">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative p-12 md:p-32 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-3xl text-center">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            ...
                            <div className="flex flex-col md:flex-row justify-center gap-6">
                                <Link href="/contact" className="px-12 py-5 bg-[#00a896] text-white rounded-full font-black text-xl hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center group   tracking-widest text-sm">
                    ...
                    <div className="mt-20 p-16 bg-gray-50 rounded-[4rem] border border-gray-100 flex flex-col lg:flex-row gap-12 items-center text-center lg:text-left">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://universecoworks.com" className="p-4 bg-[#273a96] text-white rounded-2xl hover:bg-[#1e2a78] transition-colors shadow-sm font-bold">Visit Site</a>
                        </div>
                    </div>
                </div>
            </section>
