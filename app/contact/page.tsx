...
import { MapPin, Phone, Mail, Clock, Send, MessageSquare, ChevronRight, Globe, ShieldCheck, Sparkles } from 'lucide-react';
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] font-sans selection:bg-[#273a96] selection:text-white">
      ...
      <section className="relative z-30 -mt-24 pb-32 px-4 sm:px-6 lg:px-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-10 group">
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        ...
                        <input type="text" required className="w-full px-6 py-5 rounded-[1.5rem] bg-gray-50 border-2 border-transparent focus:border-[#273a96] focus:bg-white focus:shadow-xl outline-none transition-all placeholder:text-gray-300 font-bold text-gray-900" placeholder="e.g. Anand Kumar" />
                      </div>
                      <div className="space-y-3">
                        <label className="text-xs font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Work Email</label>
                        <input type="email" required className="w-full px-6 py-5 rounded-[1.5rem] bg-gray-50 border-2 border-transparent focus:border-[#273a96] focus:bg-white focus:shadow-xl outline-none transition-all placeholder:text-gray-300 font-bold text-gray-900" placeholder="anand@company.com" />
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        ...
                        <input type="tel" required className="w-full px-6 py-5 rounded-[1.5rem] bg-gray-50 border-2 border-transparent focus:border-[#273a96] focus:bg-white focus:shadow-xl outline-none transition-all placeholder:text-gray-300 font-bold text-gray-900" placeholder="+91 97866 XXXX" />
                      </div>
                      <div className="space-y-3">
                        <label className="text-xs font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Proposed Solution</label>
                        <div className="relative">
                          <select className="w-full px-6 py-5 rounded-[1.5rem] bg-gray-50 border-2 border-transparent focus:border-[#273a96] focus:bg-white focus:shadow-xl outline-none transition-all text-gray-700 font-bold appearance-none cursor-pointer">
                ...
                <div className="space-y-10 relative z-10">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 text-[#00a896] font-black text-xs uppercase tracking-widest">
                      ...
                      <span>Thillai Nagar Hub</span>
                    </div>
                    <p className="text-white font-bold leading-relaxed">4th Floor, Kannan Towers, 11th Cross East, Trichy</p>
                  </div>
                  <div className="space-y-3 pt-6 border-t border-white/10">
                    <div className="flex items-center space-x-3 text-blue-400 font-black text-xs uppercase tracking-widest">
                      <MapPin className="h-4 w-4" />
                      <span>Cantonment Suite</span>
                    </div>
                    <p className="text-white font-bold leading-relaxed">2nd Floor, Bharath Plaza, Promenade Road, Trichy</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center group cursor-pointer">
                    ...
                    <div className="ml-6">
                      ...
                      <p className="text-lg font-black">+91 97866 55005</p>
                    </div>
                  </div>
                  <div className="flex items-center group cursor-pointer pt-6 border-t border-white/5">
                    ...
                    <div className="ml-6">
                      ...
                      <p className="text-lg font-black italic underline decoration-[#273a96]">hello@universecoworks.com</p>
                    </div>
                  </div>
                </div>
              </div>

              <Link href="/insights/faqs" className="block bg-[#00a896] rounded-[2.5rem] p-8 text-white group hover:shadow-2xl transition-all overflow-hidden relative">
