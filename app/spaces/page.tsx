    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#1a9ba8] py-20 lg:py-28 text-center text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Flexible Workspace Solutions</h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="space-y-24">
          {spaces.map((space, index) => (
            <div key={space.id} id={space.id} className={`flex flex-col ${space.reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 items-center`}>
      ...
      <section className="bg-[#0f172a] text-white py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-8">Flexible Membership Models</h2>
