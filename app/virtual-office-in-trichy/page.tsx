                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-2/3">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link href="/contact" className="px-10 py-5 bg-[#273a96] text-white rounded-full font-bold text-lg hover:bg-[#1e2a78] transition-all shadow-xl hover:-translate-y-1">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <div className="p-12 bg-white rounded-[3.5rem] border border-gray-200 shadow-sm space-y-8 flex flex-col justify-between">
                            ...
                            <Link href="/contact" className="block w-full py-4 bg-gray-900 text-white rounded-2xl text-center font-bold font-headings hover:bg-black transition-colors">Start Starter</Link>
                        </div>
                        ...
                        <div className="p-12 bg-white rounded-[3.5rem] border-2 border-[#273a96] shadow-xl space-y-8 relative overflow-hidden flex flex-col justify-between">
                            ...
                            <Link href="/contact" className="block w-full py-4 bg-[#273a96] text-white rounded-2xl text-center font-bold font-headings hover:bg-[#1e2a78] transition-colors">Go Professional</Link>
                        </div>
                        ...
                        <div className="p-12 bg-gray-900 border border-gray-800 rounded-[3.5rem] text-white space-y-8 flex flex-col justify-between">
                            ...
                            <Link href="/contact" className="block w-full py-4 bg-[#00a896] text-white rounded-2xl text-center font-bold font-headings hover:bg-[#00897b] transition-colors">Enquire Now</Link>
                        </div>
                    </div>
