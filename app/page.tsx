          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="relative h-[600px] rounded-[2.5rem] overflow-hidden shadow-2xl hidden lg:block">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#273a96]/90 to-transparent flex flex-col justify-end p-10">
                ...
                <Link href="/contact" className="bg-white text-[#273a96] px-8 py-3 rounded-full font-bold text-center hover:bg-gray-100 transition-colors">
                  Generate Enquiry
                </Link>
              </div>
            </div>
      ...
      <section className="bg-[#273a96] py-24 px-4 text-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link href="/contact" className="bg-[#00a896] text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-[#00897b] transition-transform hover:scale-105 shadow-xl shadow-teal-900/20">
              Book a Free Tour
            </Link>
