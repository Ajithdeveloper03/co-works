...
export default function PrivateOfficePageContent() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <button
                                onClick={openPopup}
                                className="px-10 py-5 bg-[#273a96] text-white rounded-full font-bold text-lg hover:bg-[#1e2a78] transition-all shadow-xl hover:shadow-[#273a96]/40 hover:-translate-y-1"
                            >
                    ...
                    <div className="relative p-12 md:p-32 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-3xl text-center">
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <div className="flex flex-col md:flex-row justify-center gap-6">
                                <button
                                    onClick={openPopup}
                                    className="px-12 py-5 bg-[#00a896] text-white rounded-full font-bold text-xl hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center group"
                                >
