...
export default function TrainingRoomPageContent() {
                    ...
                    <div className="relative p-12 md:p-32 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-3xl text-center">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            ...
                            <div className="flex flex-col md:flex-row justify-center gap-6">
                                <button
                                    onClick={openPopup}
                                    className="px-12 py-5 bg-[#00a896] text-white rounded-full font-bold text-xl hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center group uppercase tracking-widest text-sm"
                                >
