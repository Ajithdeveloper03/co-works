...
export default function DedicatedDeskPageContent() {
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-3/5">
                            ...
                            <div className="flex flex-wrap gap-4 items-center">
                                ...
                                <button
                                    onClick={openPopup}
                                    className="px-10 py-5 bg-white/5 border border-white/20 text-white rounded-full font-bold text-lg hover:bg-white/10 transition-all"
                                >
                                    Check Availability
                                </button>
                            </div>
                    ...
                    <div className="relative p-12 md:p-32 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-3xl text-center">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            ...
                            <div className="flex flex-wrap justify-center gap-6">
                                <button
                                    onClick={openPopup}
                                    className="px-12 py-5 bg-[#00a896] text-white rounded-full font-black text-xl hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1 group flex items-center"
                                >
                                    SCHEDULE FREE TOUR <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-2 transition-transform" />
                                </button>
                                <button
                                    onClick={openPopup}
                                    className="px-12 py-5 bg-white/10 text-white border border-white/20 backdrop-blur-md rounded-full font-bold text-xl hover:bg-white/20 transition-all"
                                >
