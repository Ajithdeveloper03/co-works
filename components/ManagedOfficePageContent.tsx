...
export default function ManagedOfficePageContent() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="space-y-8">
                            ...
                            <button onClick={openPopup} className="inline-flex items-center text-[#273a96] font-bold text-lg hover:underline gap-2 group">
                    ...
                    <div className="relative p-12 md:p-32 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-3xl text-center">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <div className="flex flex-col md:flex-row justify-center gap-6">
                                <button onClick={openPopup} className="px-12 py-5 bg-white text-[#273a96] rounded-full font-bold text-md hover:bg-gray-100 transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center group   tracking-widest text-sm">
