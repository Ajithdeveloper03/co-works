...
import { MapPin, Phone, Clock, Navigation, Smartphone, Globe, CheckCircle } from 'lucide-react';
                    ...
                    <div className="grid lg:grid-cols-12 gap-0 bg-[#0f172a] rounded-[4rem] overflow-hidden shadow-2xl relative group">
                        ...
                        <div className="lg:col-span-5 p-12 md:p-20 flex flex-col justify-center space-y-10 text-white relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-6">
                                ...
                                <button onClick={openPopup} className="flex items-center justify-center px-8 py-4 border-2 border-white/20 text-white rounded-2xl font-black text-lg hover:bg-white/10 transition-colors">
                                    Book a Free Tour
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-12 gap-0 bg-gray-50 rounded-[4rem] overflow-hidden shadow-xl border border-gray-100 relative group">
                        ...
                        <div className="lg:col-span-5 p-12 md:p-20 flex flex-col justify-center space-y-10 text-[#0f172a] relative z-10 order-2 lg:order-1">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-6">
                                ...
                                <button onClick={openPopup} className="flex items-center justify-center px-4 py-4 border-2 border-gray-200 text-gray-700 rounded-2xl font-black text-lg hover:border-[#273a96] hover:text-[#273a96] transition-colors">
                                    Book Tour
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="relative rounded-[4rem] bg-gray-900 p-12 md:p-24 text-center text-white overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-12">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-6">
                                <button onClick={openPopup} className="px-12 py-5 bg-[#00a896] text-white rounded-2xl font-black text-xl hover:bg-[#00897b] transition-all shadow-2xl">
                                    Schedule Tour
                                </button>
