...
export default function WorkspaceSolutionsPageContent() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button onClick={openPopup} className="px-8 py-4 bg-[#00a896] text-white rounded-full font-bold text-sm hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1">
                                Book Your Workspace Now
                            </button>
                            <button onClick={openPopup} className="px-8 py-4 bg-white/5 border border-white/20 text-white rounded-full font-bold text-sm hover:bg-white/10 transition-all backdrop-blur-sm">
                                Schedule a Tour
                            </button>
                        </div>
                    </div>
                            ...
                            <div className="space-y-10">
                                ...
                                <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-8">
                                    {[
                                        ...
                                        { icon: SparklesIcon, t: "Daily Housekeeping" },
                                        ...
                                        <div key={i} className="flex gap-4 items-center">
                                            <div className="h-12 w-12 bg-white rounded-2xl flex items-center justify-center shrink-0 border border-gray-200">
                                                <item.icon className="h-6 w-6 text-[#00a896]" />
                                            </div>
                    ...
                    <div className="relative p-12 md:p-32 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-3xl text-center">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            ...
                            <div className="flex flex-wrap justify-center gap-6">
                                <button onClick={openPopup} className="px-8 py-5 bg-[#00a896] text-white rounded-full font-black text-xl hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center group uppercase tracking-widest text-sm">
                                    BOOK WORKSPACE ONLINE <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-2 transition-transform" />
                                </button>
                                <button onClick={openPopup} className="px-12 py-5 bg-white text-[#273a96] rounded-full font-black text-xl hover:bg-gray-100 transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center">
