            ...
            <script type="application/ld+json" dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                    ...
                    "itemListElement": [{
                        ...
                        "position": 2,
                        "name": "About Universe",
                        "item": "https://universecoworks.com/about"
                    }]
                })
            }} />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20 ">
                    <div className="max-w-3xl space-y-6 md:pt-20">
                        ...
                        <div className="flex gap-4 pt-6 animate-fade-in-up delay-400">
                            <button onClick={openPopup} className="px-8 py-4 bg-[#00a896] text-white rounded-xl font-bold text-sm transition-all hover:bg-[#00897b] shadow-xl flex items-center group">
                    ...
                    <div className="bg-[#00a896] rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
                                ...
                                <button onClick={openPopup} className="px-10 py-5 bg-white text-[#00a896] rounded-xl font-bold text-lg hover:bg-gray-50 transition-all shadow-xl">
                                    Request Pricing Hub
                                </button>
                            </div>
