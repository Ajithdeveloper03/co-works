                    ...
                    <div className="bg-[#273a96] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-6">
                                <button onClick={openPopup} className="px-10 py-4 bg-white text-[#273a96] rounded-full font-bold text-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-2">
