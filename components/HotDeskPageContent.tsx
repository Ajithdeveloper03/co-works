...
export default function HotDeskPageContent() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button
                                onClick={openPopup}
                                className="px-8 py-4 bg-[#00a896] text-white rounded-full font-bold text-sm hover:bg-[#00897b] transition-all shadow-xl hover:shadow-[#00a896]/20 hover:-translate-y-1"
                            >
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        ...
                        <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-10 rounded-[3rem] border-2 border-gray-100 space-y-8 hover:border-[#00a896] transition-all group">
                                ...
                                <button
                                    onClick={openPopup}
                                    className="block w-full text-center py-4 bg-gray-900 text-white rounded-2xl font-bold group-hover:bg-[#00a896] transition-colors"
                                >
                                    Select Plan
                                </button>
                            </div>
                            ...
                            <div className="p-10 rounded-[3rem] bg-[#0f172a] text-white shadow-2xl space-y-8 relative overflow-hidden group">
                                ...
                                <button
                                    onClick={openPopup}
                                    className="block w-full text-center py-4 bg-[#00a896] text-white rounded-2xl font-bold hover:bg-[#00897b] transition-colors"
                                >
                                    Select Plan
                                </button>
                            </div>
                    ...
                    <div className="relative p-12 md:p-24 bg-[#273a96] rounded-[4rem] overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 max-w-lg">
                            ...
                            <div className="flex flex-wrap gap-6">
                                <button
                                    onClick={openPopup}
                                    className="px-10 py-5 bg-[#00a896] text-white rounded-full font-bold text-lg hover:bg-[#00897b] transition-all shadow-xl hover:-translate-y-1 flex items-center group"
                                >
